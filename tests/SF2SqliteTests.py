...
class SF2SqliteTests(TestCase):
   ...
   def test_get_datestring_without_timezone(self):
      self.setup()
      test1 = self.datehandler.get_datestring_without_timezone('2016-01-01T20:45:12+13:00')
      test2 = self.datehandler.get_datestring_without_timezone('2015-01-01T20:45:12-04:00')
      ...
      test5 = self.datehandler.get_datestring_without_timezone('1999-01-01T20:45:12$04:00')
