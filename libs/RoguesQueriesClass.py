class RogueQueries:
   ...
   SELECT_ALL_FILEPATHS = """SELECT DISTINCT FILE_PATH FROM FILEDATA WHERE FILEDATA.TYPE != 'Folder'"""
   SELECT_ALL_FOLDERS = """SELECT DISTINCT FILE_PATH FROM FILEDATA WHERE FILEDATA.TYPE = 'Folder'"""
